...
const englishMessages = {
	metadata: {
		...
		description: 'A wearable POC device where behavior becomes value and AI comes alive.',
	...
	socialMode: {
		...
		subtext: 'True social networks exist in shared rhythms and breaths, not on screens.',
		cards: [
			{
	...
	privateMode: {
		...
		subtext: 'Pause data sharing and dive into your own workout, your own time.',
		cards: [
			{
				title: 'Data Protection',
				description: 'Your personal health data stays yours. Advanced encryption ensures your biometrics and activity data are never shared without your explicit consent.',
			},
			{
				title: 'Solo Training',
				description: 'Deep focus mode silences social notifications. Track every rep, every heartbeat, every breath — just you and your goals.',
			},
			{
				title: 'Focus Mode',
				description: 'Block distractions and enter a flow state. XO Ring monitors your cognitive load and gently nudges you back when focus drifts.',
			},
			{
				title: 'Key & Payments',
				description: 'Use your ring as a secure key and payment device. Tap to unlock, tap to pay — frictionless and secure, always at hand.',
			},
		],
	},
	aiAgent: {
	...
	application: {
		...
		description: ['All your XORing data is seamlessly synced to the app.', 'You can even use the app without the ring.'],
	...
	poc: {
		...
		intro: 'The sweat from your walks and runs becomes real value. Get fairly rewarded for your time and consistency.',
		activityImageAlt: 'Activity Data Interface',
		proof: 'If a computer can prove its value by solving complex puzzles, human movement can prove its value, too.',
		steps: ['Wear XORing', 'Collect Activity Data', 'Proof of Contribution', 'Mine AIOS'],
		cards: [
			{
		...
		outro: 'Prove your value with just the XORing app. Wear the ring to capture richer data and boost your rewards.',
	...
	footer: {
		...
		address: 'Address | 1F, 15 Gangnam-daero 89-gil, Seocho-gu, Seoul, Republic of Korea',
		contact: 'Contact',
	...
	frontier: {
		...
		transferGuide: 'Copy the wallet address below and send the specified token. You will receive confirmation and next steps via email within 5 days.',
		warning: 'We are not responsible for issues caused by incorrect wallet addresses or transfers to different wallets. Please double-check before sending.',
		emailLabel: '2. Please enter the email address to bind with your official account.',
		emailHelper: 'This email will be used for token exchange updates and shipping communication, so please make sure it is entered accurately.',
		walletLabel: '3. Please enter your wallet address for whitelist registration and token transfer.',
		walletHelper: 'Your wallet address will only be used for whitelist registration and token transfer after final review.',
		consent: 'I agree to provide my email address and Web3 wallet address in order to participate in the XORing service, and I consent to the use of this information for network participation, service provision, and related communications. I also understand that this service is not an investment product and that no profits are guaranteed.',
		...
		validation: {
			...
			walletInvalid: 'Please enter a valid EVM wallet address starting with 0x.',
			agreementRequired: 'You must agree to the Terms of Service and Privacy Policy to continue.',
			submitFailed: 'Failed to submit your application. Please try again.',
			unavailable: 'Application submission is not available right now. Please try again later.',
		},
		...
		completeIntro: 'Please send the token to the designated wallet below within 3 days.',
		completeFirstComeStrong: 'Allocation is confirmed on a first-come',
		completeFirstComeRest: 'first-served basis upon successful transfer to the specified address.',
		completeShipping: 'After verification of your application and transfer, an email will be sent to request your shipping address for XO Ring.',
		completeWarning: ['Here is your wallet address again.', 'Please make sure it matches the selected token and send the exact amount.'],
		walletLabels: {
...
const chineseMessages = {
	metadata: {
		...
		keywords: ['XORing', '智能戒指', '可穿戴设备', '社交健身', 'AI 智能体', 'Web3'],
	...
	beyondScreen: {
		...
		paragraphs: [
			...
			['XORing 为此而生，', '帮助你找回那个常被无数数字身份', '遮蔽的真实自我。'],
			['走出屏幕。', '让每一次步行、每一次奔跑，', '以及每一次呼吸都真正有意义。'],
		],
	},
	twoModes: {
		headline: ['一枚戒指，', '两种模式。'],
	...
	socialMode: {
		...
		cards: [
			{
				title: '伙伴匹配',
				description: 'XO 会实时为你匹配生活方式和运动习惯相近的用户。对方就在附近时，轻碰戒指即可互动；相隔较远时，也能通过应用连接并一起运动。',
			},
			{
				title: '社交社区',
				description: '从你的社区到世界另一端，与频率相投的人建立社群，参与每天在全球各地发生的线下活动。',
			},
			{
				title: '情侣模式',
				description: '即使生活忙碌，也能安心了解彼此的状态。这不是监控，而是在完全尊重双方意愿的前提下，温和地分享日常。',
			},
			{
				title: '位置共享',
				description: '面向儿童与老年人的安全需求，提供实时位置追踪和共享，并可协助关注健康状态、发现紧急情况与异常位置变化。',
			},
		],
	},
	privateMode: {
		...
		cards: [
			{
				title: '数据保护',
				description: '你的个人健康数据始终属于你。先进的加密技术确保未经明确同意，生物特征与活动数据绝不会被共享。',
			},
			{
				title: '独立训练',
				description: '深度专注模式会静音社交通知。记录每一次动作、每一次心跳和每一次呼吸，只留下你与目标。',
			},
			{
				title: '专注模式',
				description: '屏蔽干扰，进入心流。XO Ring 会关注你的认知负荷，并在注意力偏移时温和提醒。',
			},
			{
				title: '钥匙与支付',
				description: '将戒指作为安全钥匙和支付设备。轻触即可解锁或支付，顺畅、安全且始终触手可及。',
			},
		],
	},
	aiAgent: {
		eyebrow: 'AI 智能体',
		headline: ['生活方式', '节奏伙伴'],
		subtext: ['戴上 XORing 的那一刻，你的个人 AI 智能体随即苏醒。', '它不只记录步数，还会照顾你的身体、情绪与人际关系。'],
		agents: [
			{
				title: 'AI 健康智能体',
				description: '分析心率、血氧和睡眠数据，实时预测疲劳状态并提供个性化运动管理。',
			},
			{
				title: 'AI 情绪智能体',
				description: '通过心率变异和活动状态识别压力水平，并自动推荐冥想内容或合适的音乐。',
			},
			{
				title: 'AI 社交智能体',
				description: '根据戒指的 O/X 方向识别网络状态，寻找附近兴趣与生活方式相近的用户。',
			},
			{
				title: 'AI 行为智能体',
				description: '“再消耗 400 千卡即可获得奖励。”它会设定活动目标，并在达成后发放 PoC 代币奖励。',
			},
		],
	},
	application: {
		eyebrow: '应用',
		headline: ['所有体验，', '尽在掌中'],
		description: ['你的所有 XORing 数据都会无缝同步到应用。', '即使没有戒指，也可以使用应用。'],
	...
	poc: {
		eyebrow: 'AIOS · PoC',
		headline: '汗水的价值',
		intro: '步行与奔跑流下的汗水会转化为真实价值，让你的时间与坚持得到公平回报。',
		...
		outro: '仅使用 XORing 应用也能证明你的价值；佩戴戒指则可采集更丰富的数据并提升奖励。',
		phoneAlt: 'XO 应用界面',
	},
	web3: {
	...
	pioneer: {
		headline: '先锋限量版',
		paragraphs: ['我们正在邀请首批 000 位先锋，抢先体验 XO Ring。', '一款让你的行动转化为真实价值的可穿戴设备。', '并非人人可得。\n不做大规模量产。'],
		spots: '限量 000 个名额',
	},
	policy: {
		title: '政策与社区准则',
	...
	frontier: {
		...
		transferGuide: '复制下方钱包地址并转入指定代币。我们将在 5 天内通过邮件发送确认结果与后续步骤。',
		warning: '因钱包地址填写错误或转入其他钱包而产生的问题由申请人自行承担，请务必在转账前再次核对。',
		...
		consent: '为参与 XORing 服务，我同意提供邮箱地址和 Web3 钱包地址，并同意将这些信息用于网络参与、服务提供及相关通知。我也理解本服务并非投资产品，且不保证任何收益。',
		...
		completeShipping: '申请与转账核验完成后，我们将通过邮件联系你并收集 XO Ring 的配送地址。',
		completeWarning: ['请再次确认钱包地址。', '请确保地址与所选代币一致，并转入准确金额。'],
		walletLabels: {
			usdt: 'USDT 钱包地址',
			aios: 'AIOS 钱包地址',
		},
