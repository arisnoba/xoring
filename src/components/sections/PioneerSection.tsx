		...
		<section id="pioneer" data-header-theme="light" className="relative isolate overflow-hidden bg-[#f6f6f4] text-[#111]">
			...
			<SectionContainer className="relative grid items-center gap-16 lg:grid-cols-[minmax(0,0.95fr)_minmax(0,1.05fr)]">
				<div className="flex flex-col items-center justify-center gap-10">
					<RevealOnScroll variants={scaleUp} className="w-full max-w-140">
						<RingArtwork className="w-[50vw] max-w-125 lg:w-full m-auto" />
					</RevealOnScroll>
					...
					<div className="mt-12 space-y-4">
						<RevealOnScroll variants={fadeUp} delay={0.25}>
							<div className="space-y-4">
								...
								<p className="flex flex-wrap items-end justify-center gap-x-3 gap-y-1 bg-linear-to-r from-[#999999] to-[#333333] bg-clip-text text-transparent">
